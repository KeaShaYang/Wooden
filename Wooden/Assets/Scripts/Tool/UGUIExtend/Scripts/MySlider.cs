...
namespace UnityEngine.UI
{
    ...
    public class MySlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        /// </summary>
        [SerializeField]
        private float m_RealMinValue = 0;
        public float realMinValue { get { return m_RealMinValue; } set { if (SetPropertyUtility.SetStruct(ref m_RealMinValue, value)) { Set(m_Value); UpdateVisuals(); } } }
        ...
        void UpdateDrag(PointerEventData eventData, Camera cam)
        {
            ...
            if (clickRect != null && clickRect.rect.size[(int)axis] > 0)
            {
                ...
                //限制不能小于真实的最小值
                val = Mathf.Max(realMinValue / maxValue, val);
