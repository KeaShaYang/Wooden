...
namespace Tool.UGUIExtend.Editor
{
    ...
    public class MyScrollRectEditor : UnityEditor.Editor
    {
        SerializedProperty m_Content;
        SerializedProperty m_Horizontal;
        SerializedProperty m_Vertical;
        SerializedProperty m_IsBarOnlyShowOnDraing;
        SerializedProperty m_MovementType;
        SerializedProperty m_AutoLockScroll;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_IsBarOnlyShowOnDraing = serializedObject.FindProperty("m_IsBarOnlyShowOnDraing");
            m_MovementType          = serializedObject.FindProperty("m_MovementType");
            m_AutoLockScroll        = serializedObject.FindProperty("m_AutoLockScroll");
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)MyScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((MyScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_IsBarOnlyShowOnDraing);
            ...
            EditorGUILayout.LabelField("扩展功能：内容未超框时候自动锁住滑动");
            EditorGUILayout.PropertyField(m_AutoLockScroll);
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((MyScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == MyScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((MyScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == MyScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
